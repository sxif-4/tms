...
- [x] **P2** advertisements CRUD → promotions CRUD (+ audit) → routes + sidebar ✅
- [x] **P3** `map_locations` CRUD → Leaflet client-only map feature → route + sidebar ✅
- [x] **P4** booking/payment schemas + demo seed → reports module → dashboard KPIs + analytics charts + audit-log viewer ✅
- [x] **P5** settings/roles polish, specs, empty/error states, `check-types` ✅
